...
The returned functions are all wrappers around react-query functions. Please check out [their docs](https://tanstack.com/query/latest/docs/react/overview) to learn more about them.
